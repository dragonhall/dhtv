...
guard 'rails', server: 'puma', host: '127.0.0.1', port: port_base + 1, environment: (ENV['RAILS_ENV'] || 'development') do
  watch('Gemfile.lock')
  watch(%r{^(config|lib)/.*})
end
...
guard 'spring', bundler: true do
  watch('Gemfile.lock')
  watch(%r{^config/(initializers/.+|environments/development|environments/test|application)\.rb})
